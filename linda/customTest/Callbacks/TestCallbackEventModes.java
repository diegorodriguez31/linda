...
public class TestCallbackEventModes {
    ...
    public static void main(String[] a) {
        ...
        linda.eventRegister(Linda.eventMode.READ, Linda.eventTiming.FUTURE, cbMotif, new TestCallbackEventModes.MyReadCallback());
        linda.eventRegister(Linda.eventMode.TAKE, Linda.eventTiming.FUTURE, cbMotif, new TestCallbackEventModes.MyTakeCallback());
